      ...
      <tr>
		<td>
        	...
        	<div class="card" id="cardd" style="margin: 0px !important;background-color: white; text-align: center;">
        		<!-- Card content -->
  				<div class="card-body cardImage" style="background: url('https://www.methacton.org/cms/lib/PA01000176/Centricity/ModuleInstance/18991/large/Methacton%20High%20School-cropped-cropped.jpg') no-repeat center center;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
            height: 125px;"></div>
   				<h5 class="card-title" style="font-weight: bold; color: #0d47a1; padding-top: 5px;">School name</h5>
        	</div>
        	</a>
        </td>
      </tr>
